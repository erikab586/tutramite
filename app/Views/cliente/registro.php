...
<head>
    ...
    <title>Cueta | Presuepuesto</title>
    <!-- Favicon-->
...
<body class="signup-page">
    <div class="signup-box">
        <div class="logo">
          <a href="javascript:void(0);"><img style="width:50%; heigth:35%;"src="images/logo.jpeg"></a>
        </div>
        <div class="card">
            <div class="body">
                <form action="<?php echo base_url('crear'); ?>"  method="post">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="telefono" placeholder="Telefono" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="m-t-25 m-b--5 align-center">
                        <a href="<?=base_url('login')?>">Tienes Cuenta?</a>
                    </div>
                </form>
            </div>
        </div>
