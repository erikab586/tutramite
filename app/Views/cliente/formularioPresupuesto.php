                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <form id="form_validation_stats" method="POST" action="<?=base_url('cargarPresupuesto')?>" enctype="multipart/form-data">
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" class="form-control date" name="material" placeholder="Material">
                                                </div>
                                                <span class="input-group-addon">
                                    ...
                                    <h2 class="card-inside-title">Materiales</h2>
                                    <div class="row clearfix">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <div class="form-line">
                                                    <select name="madera" id="madera">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <div class="form-line">
                                                    <select name="cuero" id="cuero">
                                                        <option value="" disabled selected>Cuero</option>
                                                        <?php foreach ($cuero as $item){ ?>
                                                            <option value="<?= $item['id_producto']?>"><?= $item['nombre_producto']?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
