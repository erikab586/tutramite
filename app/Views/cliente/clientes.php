                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<?= base_url('clientela')?>">Crear</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php }?>
                                            <td>
                                                <a href="<?php echo base_url('editarcliente')."/".$i['id_cliente']?>" class="btn btn-success btn-circle waves-effect waves-circle waves-float">
                                                    <i class="material-icons">create</i>
                                                </a>
                                                <a href="<?php echo base_url('/eliminarcliente')."/".$i['id_cliente']?>" class="btn bg-red btn-circle waves-effect waves-circle waves-float">
