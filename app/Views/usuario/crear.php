                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form id="form_validation_stats" method="POST" action="<?=base_url('formadmin')?>" enctype="multipart/form-data">
                                <div class="row clearfix">
                                    <div class="col-md-4">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <div class="form-line">
                                                <select name="estatus">
                                                    <option value="" disabled selected>Estatus de Usuario</option>
